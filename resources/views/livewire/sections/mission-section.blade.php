    ...
    <div class="container">
        ...
        <div class="row value-cards">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-image">
                        <img src="{{ Vite::asset('resources/theme/img/icons/5236.jpg')}}" alt="personnes tenant des feuilles" />
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-image">
                        <img src="{{ Vite::asset('resources/theme/img/icons/5236.jpg')}}" alt="mains assemblant un puzzle" />
                    </div>
                    <div class="card-body">
